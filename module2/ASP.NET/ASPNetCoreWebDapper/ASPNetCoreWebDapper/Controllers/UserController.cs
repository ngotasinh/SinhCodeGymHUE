...
using ASPNetCoreWebDapper.Models.User;
...
namespace ASPNetCoreWebDapper.Controllers
{
    public class UserController : Controller
    {
        public IActionResult Index()
        {
            ...
            var url = "http://localhost:63521/api/user/gets";
        ...
        public IActionResult Details(int id)
        {
            ...
            var url = "http://localhost:63521/api/user/get/" + id;
            HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
            httpWebRequest.Method = "GET";
            var response = httpWebRequest.GetResponse();
            {
        ...
        public IActionResult Edit(UserEdit model)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:63521/api/user/update");
            httpWebRequest.ContentType = "application/json";
        ...
        public IActionResult Delete(int id)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:63521/api/user/delete");
            httpWebRequest.ContentType = "application/json";
        ...
        private List<Country> GetCountries()
        {
            ...
            var url = "http://localhost:63521/api/Country/gets";
            HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
            httpWebRequest.Method = "GET";
            var response = httpWebRequest.GetResponse();
            {
